...
"resource": {
  ...
  "tags":[{
      ...
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript async type=\"text\/gtmscript\"\u003Eytag({type:\"yss_conversion\",config:{yahoo_conversion_id:\"",["escape",["macro",43],7],"\",yahoo_conversion_label:\"",["escape",["macro",44],7],"\",yahoo_conversion_value:\"0\"}});\u003C\/script\u003E\n"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":260
...
d;e=void 0===e?!0:e;var g=vj(),h=g.gclid||"",l=g.gclsrc,m=g.dclid||"",p=!a&&(!h||l&&"aw.ds"!==l?!1:!0),n=zg();if(p||n)n?Ig(function(){f();Gg(I.C)||Cg(function(t){return f(!0,t.pf)},I.C)},[I.C]):f()}function Pm(a,b){var c=a&&!Gg(I.C);return b&&c?"0":b}
var Zm=function(a){return!(void 0===a||null===a||0===(a+"").length)},$m=function(a,b){var c;if(2===b.fa)return a("ord",Sa(1E11,1E13)),!0;if(3===b.fa)return a("ord","1"),a("num",Sa(1E11,1E13)),!0;if(4===b.fa)return Zm(b.sessionId)&&a("ord",b.sessionId),!0;if(5===b.fa)c="1";else if(6===b.fa)c=b.Wd;else return!1;Zm(c)&&a("qty",c);Zm(b.Ac)&&a("cost",b.Ac);Zm(b.transactionId)&&a("ord",b.transactionId);return!0},bn=function(a,b,c){function d(x,z,A){p.hasOwnProperty(x)||(z=String(z),m.push(";"+x+"="+(A?
z:an(z))))}var e=a.Bd,f=a.Zd,g=a.protocol;g+=f?"//"+e+".fls.doubleclick.net/activityi":"//ad.doubleclick.net/activity";var h=";",l=!Gg(I.C)&&a.Vb;l&&(g="https://ade.googlesyndication.com/ddm/activity",h="/",f=!1);var m=[h,"src="+an(e),";type="+an(a.Ed),";cat="+an(a.Ib)],p=a.uh||{};Va(p,function(x,z){m.push(";"+an(x)+"="+an(z+""))});if($m(d,a)){Zm(a.Tc)&&d("u",a.Tc);Zm(a.Sc)&&d("tran",a.Sc);d("gtm",hm());zg()&&(d("gcs",Hg()),c&&d("gcu","1"));(function(x,z){z&&
d(x,z)})("gdpr_consent",Km());"1"===bj(!1)._up&&d("gtm_up","1");!1===a.Xg&&d("npa","1");if(a.yd){var n=void 0===a.Vb?!0:!!a.Vb,t=Lj("dc",a.kb,n);t&&t.length&&d("gcldc",t.join("."));var r=Lj("aw",a.kb,n);r&&r.length&&d("gclaw",r.join("."));var u=Mj(n);u&&d("gac",u);Ci({prefix:a.kb,Sb:a.rh,domain:a.qh,flags:a.Wi});var v=xi[yi(a.kb)];v&&d("auiddc",v)}Zm(a.Rd)&&d("prd",a.Rd,!0);Va(a.ce,function(x,z){d(x,z)});m.push(b||"");if(Zm(a.Jc)){var w=a.Jc||"";l&&(w=dh(w));
d("~oref",w)}var y=g+m.join("")+"?";f?cg(y,a.M):fg(y,a.M,a.L)}else O(a.L)},an=encodeURIComponent,cn=function(a,b){zg()?Ig(function(){bn(a,b);Gg(I.C)||Cg(function(){bn(a,b,!0)},I.C)},[I.C]):bn(a,b)};var Bn=function(){var a=!0;Lm(7)&&Lm(9)&&Lm(10)||(a=!1);var b=!0;b=!1;b&&!An()&&(a=!1);return a},An=function(){var a=!0;Lm(3)&&Lm(4)||(a=!1);return a};var Xn=!1;function Yn(){var a=R;return a.gcq=a.gcq||new Zn}
...
function So(a,b){}function To(a,b,c){};function Uo(a,b){H(this.o.g,["toPath:!string","fromPath:!string"],arguments);kf(this,"access_globals","write",a);kf(this,"access_globals","read",b);var c=a.split("."),d=b.split("."),e=[];var f=pb(c,e),g=pb(d,e);if(void 0===f||void 0===g)return!1;f[c[c.length-1]]=g[d[d.length-1]];
...
for(var l=[],m=1;m<arguments.length;m++)l.push(Hb(arguments[m],this.s,h));var p=(0,this.s.U)(f,e,l);c=Gb(p,this.s);void 0===c&&void 0!==p&&L(45);return c};function Wo(a){};function Xo(a){};var Yo=!1,Zo=[];function $o(){if(!Yo){Yo=!0;for(var a=0;a<Zo.length;a++)O(Zo[a])}}var ap=function(a){Yo?O(a):Zo.push(a)};function bp(a){H(this.o.g,["listener:!Fn"],arguments);kf(this,"process_dom_events","window","load");ap(Hb(a))};function cp(a,b){var c;var e=!1;var f=Gb(c,this.s,e);void 0===f&&void 0!==c&&L(45);return f};function dp(a){var b;H(this.o.g,["path:!string"],arguments);kf(this,"access_globals","read",a);var c=a.split("."),d=E,e;for(e=0;e<c.length-1;e++){d=d[c[e]];if(null==d)return;}b=d[c[e]];var f=!1;var g=Gb(b,this.s,f);void 0===g&&void 0!==b&&L(45);return g};function ep(a,b){var c=null,d=!1;H(this.o.g,["functionPath:!string","arrayPath:!string"],arguments);kf(this,"access_globals","readwrite",a);kf(this,"access_globals","readwrite",b);var e=[];
var f=a.split("."),g=pb(f,e),h=f[f.length-1];if(void 0===g)throw Error("Path "+a+" does not exist.");var l=g[h];if(l&&!Na(l))return null;if(l)return Gb(l,this.s,d);var m;l=function(){if(!Na(m.push))throw Error("Object at "+b+" in window is not an array.");m.push.call(m,arguments)};g[h]=l;var p=b.split("."),n=pb(p,e),t=p[p.length-1];if(void 0===n)throw Error("Path "+p+" does not exist.");m=n[t];void 0===m&&(m=[],n[t]=m);c=function(){l.apply(l,Array.prototype.slice.call(arguments,0))};
...
function uu(a,b){}var Z={h:{}};Z.h.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.i="ctv";Z.__ctv.m=!0;Z.__ctv.priorityOverride=0})(function(){return"83"})}();
...
Z.h.flc=[],function(){function a(b,c){c=c?c.slice(0,-1):void 0;cn(b,c)}(function(b){Z.__flc=b;Z.__flc.i="flc";Z.__flc.m=!0;Z.__flc.priorityOverride=0})(function(b){var c=!b.hasOwnProperty("vtp_enableConversionLinker")||b.vtp_enableConversionLinker,d=Vr(b.vtp_customVariable||[],"key","value")||{},e={Ib:b.vtp_activityTag,yd:c,kb:b.vtp_conversionCookiePrefix||void 0,Ac:void 0,fa:{UNIQUE:3,SESSION:4}[b.vtp_ordinalType]||2,Bd:b.vtp_advertiserId,Ed:b.vtp_groupTag,L:b.vtp_gtmOnFailure,M:b.vtp_gtmOnSuccess,
Jc:b.vtp_useImageTag?void 0:b.vtp_url,protocol:"",Wd:void 0,Zd:!b.vtp_useImageTag,sessionId:b.vtp_sessionId,Sc:b.vtp_transactionVariable,transactionId:void 0,Tc:b.vtp_userVariable,ce:d},f=!Gg(I.C)&&void 0!=fr(I.R)&&!1!==fr(I.R);e.Vb=f;if(b.vtp_enableAttribution){var g=b.vtp_attributionFields||[];if(g.length){T("//www.gstatic.com/attribution/collection/attributiontools.js",function(){a(e,X("google_attr").build([Vr(g,"key","value")||{}]))},b.vtp_gtmOnFailure);return}}a(e)})}();
Z.h.c=["google"],function(){(function(a){Z.__c=a;Z.__c.i="c";Z.__c.m=!0;Z.__c.priorityOverride=0})(function(a){pr(a.vtp_value,"c",a.vtp_gtmEventId);return a.vtp_value})}();
...
Z.h.f=["google"],function(){(function(a){Z.__f=a;Z.__f.i="f";Z.__f.m=!0;Z.__f.priorityOverride=0})(function(a){var b=fr("gtm.referrer",1)||N.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?ah(ch(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):er(String(b)):String(b)})}();Z.h.k=["google"],function(){(function(a){Z.__k=a;Z.__k.i="k";Z.__k.m=!0;Z.__k.priorityOverride=0})(function(a){return ir(a.vtp_name,fr("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
t+".");},P:a}})}();Z.h.r=["google"],function(){(function(a){Z.__r=a;Z.__r.i="r";Z.__r.m=!0;Z.__r.priorityOverride=0})(function(a){return Sa(a.vtp_min,a.vtp_max)})}();
